 ...
 * Date: 11/30/12
 */
public class NativeMethodRealDivideByAssign extends NativeMethod {

    public static final String EtqMthRealDivAssign = "/=";

    public NativeMethodRealDivideByAssign(Runtime rt)
    {
        super( rt, EtqMthRealDivAssign );
    }
            ...
            throws InterpretError
    {
        ...
        toret = self;
        self.assign( NativeMethodRealDivideBy.doDivision( params[ 0 ].toString(), self, arg ) );

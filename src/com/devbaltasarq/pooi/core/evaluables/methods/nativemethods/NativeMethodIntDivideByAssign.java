 ...
 * Date: 11/30/12
 */
public class NativeMethodIntDivideByAssign extends NativeMethod {

    public static final String EtqMthIntDivAssign = "/=";

    public NativeMethodIntDivideByAssign(Runtime rt)
    {
        super( rt, EtqMthIntDivAssign );
    }
            ...
            throws InterpretError
    {
        ...
        toret = self;
        self.assign( NativeMethodIntDivideBy.doDivision( params[ 0 ].toString(), self, arg ) );

...
import core.evaluables.Command;
...
public class Interpreter {
    ...
    private final void createAuxiliaryObjects() throws InterpretError
    {
        ...
        this.author =  rt.createObject( "author" );
        this.author.set( name.getName(), name );
        this.author.set( email.getName(), email );

        // about object
        ObjectStr appName =  rt.createString( "appName", AppInfo.Name );
        ObjectStr version =  rt.createString( "appVersion", AppInfo.Version );
        this.about =  rt.createObject( "about" );
        this.about.set( appName.getName(), appName );
        this.about.set( version.getName(), version );
        ...
        ObjectBag help = rt.createObject( "help" );
        help.set( use.getName(), use );
        help.set( msgs.getName(), msgs );
    }
    ...
    private ObjectBag author;
    private ObjectBag about;
